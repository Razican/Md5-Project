			...
			<tr align="center" valign="middle">
				...
				<td width="160" style="background: url(<?php echo skin_path(); ?>images/menucenter.png);">
					<div id="lang"><ul><li class="level1"><a class="level1"><?php echo lang('menu.language'); ?></a>
						<ul>
							<li><?php echo anchor('es/encryptor/','Español', 'class="level2"'); ?></li>
							<li><?php echo anchor('en/encryptor/','English', 'class="level2"'); ?></li>
							<li><?php echo anchor('eu/encryptor/','Euskara', 'class="level2"'); ?></li>
						</ul>
					</li></ul></div>
				</td>
