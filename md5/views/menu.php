		<table width="720" height="30" border="0" align="center" cellspacing="0">
			<tr align="center" valign="middle">
				...
				<td width="125" style="background: url(<?php echo skin_path(); ?>images/menucenter.png);" class="menutext"><?php echo lang('menu.version'); ?>: <?php echo number_format($this->config->item('version'),1,".",","); ?></td>
