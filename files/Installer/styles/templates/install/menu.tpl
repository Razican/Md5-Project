<table style="height: 30px;" width="730" border="0" align="center" cellspacing="0" >
	<tr align="center" valign="middle">
		...
		<td width="115" style="background: url(./../styles/images/menucenter.png);">
			<div id="lang"><ul>
				<li class="level1"><a class="level1">{lan}</a>
					<ul>
		...
		<td width="150" style="background: url(./../styles/images/menucenter.png);" class="menutext">{ins_menu}:</td>
