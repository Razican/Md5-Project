...
function display ($page, $foot = true, $menu = true) //Definimos la funcion
{
	...
	$DisplayPage ="<!DOCTYPE html PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\" \"http://www.w3.org/TR/html4/loose.dtd\">
	<html>
	...
	<body style=\"background-image: url(".$root_path."styles/images/background.png);\"><center><br>"; //La primera parte de la pagina
...
{
	global $root_path; //variables globales

	$filename	= $root_path. TEMPLATE_DIR .'/'. $templatename.'.tpl'; //definimos el archivo
...
{
	global $lang, $sellang, $root_path; //las globales
...
else //si no
{
	...
	include ($root_path."language/". $SelLanguage ."/". $filename.".mo"); //incluimos el archivo de lenguaje
}
function ShowMenu () //definimos la funcion
{
	global $sellang, $lang, $parse, $file, $error; //variables globales
