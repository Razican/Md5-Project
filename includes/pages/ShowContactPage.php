...
if (!defined('INSIDE'))
{
	...
	$parse['table']	= "</table>
	<table width=\"603\" border=\"1\" cellspacing=\"0\" bordercolor=\"#000000\"><tr>
	<td align=\"center\" valign=\"middle\" bgcolor=\"#FF3300\" bordercolor=\"#000000\"><font color=\"lime\">".$lang['nickname']."</font></td>
	<td align=\"center\" valign=\"middle\" bgcolor=\"#FF3300\" bordercolor=\"#000000\"><font color=\"lime\">".$lang['rank']."</font></td>
	<td align=\"center\" valign=\"middle\" bgcolor=\"#FF3300\" bordercolor=\"#000000\"><font color=\"lime\">".$lang['email']."</font></td>
	<td align=\"center\" valign=\"middle\" bgcolor=\"#FF3300\" bordercolor=\"#000000\"><font color=\"lime\">".$lang['work']."</font></td>
	</tr>".$credlist."</table>"; //Creamos la tabla
	$file		= "index".$phpEx."?page=contact&"; //le decimos cual será el archivo
