<?php
//changelog.php
$lang['changelogtitle'] = "Aldaketa zerrenda";
$lang['Version']     = "Bertsioa";
$lang['Description'] = "Deskribapena";
$lang['changelog']   = array(
"<font color='lime'>1.4</font>" => " Datarik gabe

- [FIX]W3C erakundeak kodea balioztatu du.
- [FIX]Desenkriptatzaileak hash bat baino gehiago bilatzen zuen.
- Aktualizatzaile berria.
- Programa instalazio fitxategiak borratzen saiatuko da.
- Instalatzailea fitxategien baimenak aldatzen saiatuko da.
- Datu base handiagoa.
- Fitxategi luzapenak kenduta.
- Favicon berria.
",
"1.3" => " 2011/04/04
...
- Programa %100 euskarara, ingelesera eta erderara itzulita.
