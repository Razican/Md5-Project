...
$lang['ins_menu']		= "Installation menu";
...
$lang['desc1']			= "The Md5 Project is a program wich encrypts a string and introduces it to a database, then, it decrypts the hash. Currently the project is supported <a href=\"http://desencriptador.co.cc\">here</a>. The 1.1 version of the program is very stable and it's finished. There may be changes if we get bug reports.";
$lang['desc2']			= "The installation system will guide you through the installation process. If you have any question or problem please do not hesitate to contact <a href=\"mailto:iem10393@gmail.com\"><em>Razican</em></a>.";
